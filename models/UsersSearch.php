...
class UsersSearch extends Users
{
    ...
    {
        return [
            [['id', 'confirmation_sent_at', 'confirmed_at', 'recovery_sent_at', 'blocked_at', 'registered_from', 'logged_in_from', 'logged_in_at', 'created_at', 'updated_at', 'department_id', 'position_id', 'degree_id'], 'integer'],
            [['username', 'email', 'password_hash', 'auth_key', 'confirmation_token', 'unconfirmed_email', 'recovery_token', 'registration_ip', 'role', 'name', 'depname'], 'safe'],
        ];
    }
